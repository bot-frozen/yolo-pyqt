...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C2f_Faster', 'C3_Faster', 'C3_ODConv', 'C2f_ODConv', 'Partial_conv3', 'C2f_Faster_EMA', 'C3_Faster_EMA', 'C2f_DBB',
           ...
           'EUCB_SC', 'CSP_MSCB_SC', 'C2f_LEGM', 'C2f_LSBlock', 'C2f_MambaOut_LSConv', 'LoGStem', 'C2f_LFEM', 'C2f_RCB', 'C2f_TransMamba', 'C2f_EVS', 'C2f_EBlock', 'C2f_DBlock', 'SNI', 'GSConvE', 'C2f_SFSConv', 'FCM', 'FCM_1', 'FCM_2', 'FCM_3', 'Pzconv',
           'C2f_GroupMambaBlock', 'C2f_MambaVision', 'PST', 'FourierConv', 'C2f_FourierConv', 'C2f_GLVSS', 'C2f_ESC', 'C2f_ConvAttn', 'C2f_UniConv', 'GCConv', 'C2f_GCConv', 'MANet_GCConv', 'C2f_CFBlock', 'C2f_CSSC', 'C2f_CNCM', 'C2f_HFRB', 'C2f_EVA'
           ]
...
class C2f_EVA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(EVA(self.c, kernel_size=7) for _ in range(n))
